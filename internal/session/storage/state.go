...
// An initial session state during which the game is not yet started.
...
// A state right after the game starts.
...
// A state while a game task is in progress.
...
// A state while players vote for each other's answers.
...
// A state right after a task ends.
